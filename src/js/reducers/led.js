...
export default function update (state = initialState, action) {
  if (action.type === constants.INIT_LED) {
    ...
    if (state.power) {
      overwolf.logitech.led.setLightingForKeyWithKeyName(newLayout[index].keyname, 0, 0, 0, (res) => {});
      overwolf.logitech.led.setLightingForKeyWithKeyName(action.key, newLayout[index].color.r, newLayout[index].color.g, newLayout[index].color.b, (res) => {});
    }
    ...
    if (state.power) {
      overwolf.logitech.led.setLightingForKeyWithKeyName(newLayout[index].keyname, 0, 0, 0, (res) => {});
      overwolf.logitech.led.setLightingForKeyWithKeyName(newLayout[index].keyname, r, g, b, (res) => {});
    }
