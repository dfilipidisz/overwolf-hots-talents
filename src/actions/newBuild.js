...
export const changeName = (e) => {
  return function (dispatch) {
    return dispatch({ type: NEW_BUILD_CHANGE_NAME, name: e.target.value });
  };
};

export const changeTalent = (e) => {
  return function (dispatch) {
    return dispatch({ type: NEW_BUILD_CHANGE_TALENT, id: e.currentTarget.dataset.id, lvl: e.currentTarget.dataset.lvl });
  };
};

export const saveNewBuild = () => {
